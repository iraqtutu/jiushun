...
function initRuntimeSocketService() {
  const hosts = "198.19.255.253,192.168.1.3,127.0.0.1,172.29.80.1";
  const port = "8090";
  const id = "mp-weixin_WcHEoJ";
...
const pages = [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "玖顺农机服务",
      enablePullDownRefresh: false
    }
  },
  {
    path: "pages/register/apply",
    style: {
      navigationBarTitleText: "账号申请"
    }
  },
  {
    path: "pages/work-order/create",
    style: {
      navigationBarTitleText: "新建派工单"
    }
  },
  {
    path: "pages/work-order/list",
    style: {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","198.19.255.253","192.168.1.3","172.29.80.1"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/Program Files/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"jiushun","spaceId":"mp-e053b326-d336-455f-9572-3993ef17dc83","clientSecret":"JU7d4Fh544SRs3vx+xKVcA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__2174B9F";
} catch (e2) {
